...
{	
	...
	// METODOS INTERFACE PARA LAS FUNCIONALIDADES
	...
	public CachedRowSet sendConsult(String SQLquery) 
	throws SQLException
	{
		try {
			return comLink.execConsult(SQLquery);
		} catch (UntestedConnectionException u)	{
			// TODO cartelito de error super maligno
			u.printStackTrace();
		}
		return null;
	}
	...
	public void sendCommand(String SQLquery) 
	throws SQLException 
	{
		try {
	...
	public void populateTable(DefaultTableModel data, String SQLquery)
	throws SQLException
	{
	...
	public void populateComboBox(DefaultComboBoxModel data, String SQLquery)
	throws SQLException
	{
		CachedRowSet crs = this.sendConsult(SQLquery);
	...
	public void populateList (DefaultListModel data, String SQLquery) 
	throws SQLException
	{
		CachedRowSet crs = this.sendConsult(SQLquery);
		data.removeAllElements();
	...
	protected void registerNewButtonFor(Command comm, JPanel where, String iconPath, String buttonLabel) 
	throws InvalidButtonLocation
	{
	...
	// TODO
	// Metodos como el de arriba para menues de los distintos tipos
	// e items dentro de esos menues
